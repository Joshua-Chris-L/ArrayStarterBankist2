...
// const calDaysPassed = (date1, date2) => (date2 - date1)

// console.log(calDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 24) ))
// const now = new Date();
